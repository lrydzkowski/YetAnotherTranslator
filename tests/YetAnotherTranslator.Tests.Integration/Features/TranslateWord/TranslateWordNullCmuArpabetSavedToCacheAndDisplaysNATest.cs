...
public class TranslateWordNullCmuArpabetSavedToCacheAndDisplaysNATest : TestBase
{
    private TranslateWordHandler _handler = null!;

    public TranslateWordNullCmuArpabetSavedToCacheAndDisplaysNATest(IntegrationTestFixture fixture) : base(fixture)
    {
    }
