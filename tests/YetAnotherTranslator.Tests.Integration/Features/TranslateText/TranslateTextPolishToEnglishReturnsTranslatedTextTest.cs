...
public class TranslateTextPolishToEnglishReturnsTranslatedTextTest : TestBase
{
    private TranslateTextHandler _handler = null!;

    public TranslateTextPolishToEnglishReturnsTranslatedTextTest(IntegrationTestFixture fixture) : base(fixture)
    {
    }
