...
public class TranslateWordCacheHitReturnsFromCacheTest : TestBase
{
    private TranslateWordHandler _handler = null!;

    public TranslateWordCacheHitReturnsFromCacheTest(IntegrationTestFixture fixture) : base(fixture)
    {
    }
  ...
  ""translations"": [
    {
      ...
      ""examples"": [""The dog barked loudly.""]
        ...
        var request = new TranslateWordRequest("pies", SourceLanguage.Polish, "English", UseCache: true);
