...
public class TranslateTextMultiLineWithEscapedNewlinesPreservesFormattingTest : TestBase
{
    private TranslateTextHandler _handler = null!;

    public TranslateTextMultiLineWithEscapedNewlinesPreservesFormattingTest(IntegrationTestFixture fixture) : base(fixture)
    {
    }
